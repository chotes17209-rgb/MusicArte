...
<div class="row g-3">
    <div class="col-md-4">
        <a href="<?php echo e(route('reportes.alumnos-especialidad')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('reportes.asistencia-mensual')); ?>" class="text-decoration-none">
            <div class="card p-3 h-100">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('reportes.ingresos-egresos')); ?>" class="text-decoration-none">
            <div class="card p-3 h-100">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('reportes.pagos-pendientes')); ?>" class="text-decoration-none">
            <div class="card p-3 h-100">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('reportes.pagos-anual')); ?>" class="text-decoration-none">
            <div class="card p-3 h-100">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('reportes.planilla-maestros')); ?>" class="text-decoration-none">
            <div class="card p-3 h-100">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('reportes.clases')); ?>" class="text-decoration-none">
            <div class="card p-3 h-100">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\musicarte\resources\views/reportes/index.blade.php ENDPATH**/ ?>