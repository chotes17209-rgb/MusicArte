<?php $__env->startSection('titulo', 'Caja Chica'); ?>
        ...
        <table class="table align-middle">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $movimientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e($m->proveedor ?? '—'); ?></td>
                    <td><?php echo e($m->descripcion); ?></td>
                    <td class="fw-semibold">S/ <?php echo e(number_format($m->monto, 2)); ?></td>
                    <td class="text-end">
                        <button class="btn btn-sm btn-light btn-icon" onclick="editarMovimiento(<?php echo e($m->id); ?>)"><i class="bi bi-pencil"></i></button>
                        <button class="btn btn-sm btn-light btn-icon text-danger" onclick="eliminarMovimiento(<?php echo e($m->id); ?>, '<?php echo e($m->descripcion); ?>')"><i class="bi bi-trash"></i></button>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\musicarte\resources\views/caja-chica/index.blade.php ENDPATH**/ ?>