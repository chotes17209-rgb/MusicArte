<?php $__env->startSection('titulo', 'Recitales y Eventos'); ?>
...
<div class="card p-3">
    <div class="table-responsive">
        <table class="table align-middle">
            ...
            <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $recitales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="fw-semibold"><?php echo e($r->nombre); ?></td>
                    <td><?php echo e(optional($r->fecha)->format('d/m/Y') ?? '—'); ?></td>
                    <td><?php echo e($r->tema ?? '—'); ?></td>
                    <td><?php echo e($r->pago_por_alumno ? 'S/ '.number_format($r->pago_por_alumno,2) : '—'); ?></td>
                    <td class="text-end">
                        <button class="btn btn-sm btn-light btn-icon" onclick="editarRecital(<?php echo e($r->id); ?>)"><i class="bi bi-pencil"></i></button>
                        <button class="btn btn-sm btn-light btn-icon text-danger" onclick="eliminarRecital(<?php echo e($r->id); ?>, '<?php echo e($r->nombre); ?>')"><i class="bi bi-trash"></i></button>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\musicarte\resources\views/recitales/index.blade.php ENDPATH**/ ?>