<?php $__env->startSection('titulo', 'Maestros'); ?>
...
<div class="card p-3">
    <div class="table-responsive">
        <table class="table align-middle">
            ...
            <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $maestros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="fw-semibold"><?php echo e($m->nombre); ?></td>
                    <td>
                        <?php $__empty_2 = true; $__currentLoopData = $m->especialidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $esp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <span class="badge mb-1" style="background:<?php echo e($esp->color); ?>" title="S/ <?php echo e(number_format($esp->pivot->tarifa_hora, 2)); ?> por hora"><?php echo e($esp->nombre); ?> · S/<?php echo e(number_format($esp->pivot->tarifa_hora, 0)); ?>/h</span>
                            ...
                            <div class="row g-2 align-items-center mb-1">
                                <div class="col-7">
                                    <div class="form-check">
                                        <input class="form-check-input maestro-especialidad-check" type="checkbox" value="<?php echo e($esp->id); ?>" id="esp_check_<?php echo e($esp->id); ?>" onchange="toggleTarifaInput(<?php echo e($esp->id); ?>)">
                                        <label class="form-check-label small" for="esp_check_<?php echo e($esp->id); ?>"><?php echo e($esp->nombre); ?></label>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <input type="number" step="0.5" min="0" class="form-control form-control-sm maestro-tarifa-input" id="esp_tarifa_<?php echo e($esp->id); ?>" placeholder="S//hora" disabled>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\musicarte\resources\views/maestros/index.blade.php ENDPATH**/ ?>