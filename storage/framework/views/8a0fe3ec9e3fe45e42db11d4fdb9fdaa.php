    ...
    <form class="row g-2" id="formFiltrosAlumnos" method="GET" onsubmit="return false;">
        <div class="col-md-3">
            <input type="text" name="buscar" id="filtro_buscar" class="form-control"
                   placeholder="Buscar por nombre, DNI o tutor..." value="<?php echo e(request('buscar')); ?>" autocomplete="off">
        </div>
        <div class="col-md-2">
...
<script>
    ...
    async function buscarAlumnosReactivo(url = null) {
        ...
        const target = url || (`<?php echo e(route('alumnos.index')); ?>?` + params.toString());
