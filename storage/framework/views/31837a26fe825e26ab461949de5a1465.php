...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    ...
    <div class="d-flex gap-2 flex-wrap">
        <a href="<?php echo e(route('horarios.tablero', ['periodo_id' => $periodoId])); ?>" class="btn btn-outline-secondary"><i class="bi bi-grid-3x3-gap me-1"></i> Ver tablero por maestro</a>
        <a href="<?php echo e(route('horarios.mensual')); ?>" class="btn btn-outline-secondary"><i class="bi bi-calendar-week me-1"></i> Vista mensual</a>
...
<div class="card p-3 mb-3">
    <form method="GET" class="d-flex gap-2 align-items-center flex-wrap">
        ...
        <span class="text-muted small"><?php echo e($horarios->count()); ?> horario(s) en este periodo</span>
    </form>
</div>
        ...
        <table class="table align-middle">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $horarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="text-end">
                        <button class="btn btn-sm btn-light btn-icon" onclick="editarHorario(<?php echo e($h->id); ?>)" title="Editar"><i class="bi bi-pencil"></i></button>
                        <button class="btn btn-sm btn-light btn-icon text-danger" onclick="eliminarHorario(<?php echo e($h->id); ?>, '<?php echo e($h->alumno->nombre ?? ''); ?>')" title="Eliminar"><i class="bi bi-trash"></i></button>
                    </td>
                </tr>
...
<script>
    ...
    function nuevoHorario() {
        ...
        document.getElementById('horario_periodo_id').value = '<?php echo e($periodoId); ?>';
    ...
    async function editarHorario(id) {
        ...
        document.getElementById('horario_periodo_id').value = d.periodo_id ?? '<?php echo e($periodoId); ?>';
