<?php $__env->startSection('titulo', 'Avisos'); ?>
...
<div class="card p-3">
    <div class="table-responsive">
        <table class="table align-middle">
            ...
            <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $avisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="fw-semibold"><?php echo e($a->titulo); ?></td>
                    <td>
                        <?php $badge = ['info'=>'bg-primary','advertencia'=>'bg-warning text-dark','urgente'=>'bg-danger'][$a->tipo] ?>
                        <span class="badge <?php echo e($badge); ?>"><?php echo e(ucfirst($a->tipo)); ?></span>
                    </td>
                    <td class="small"><?php echo e(optional($a->fecha_inicio)->format('d/m/Y') ?? 'Sin inicio'); ?> — <?php echo e(optional($a->fecha_fin)->format('d/m/Y') ?? 'Sin fin'); ?></td>
                    <td><?php echo e($a->autor->name ?? '—'); ?></td>
                    ...
                    <td class="text-end">
                        <button class="btn btn-sm btn-light btn-icon" onclick="editarAviso(<?php echo e($a->id); ?>)"><i class="bi bi-pencil"></i></button>
                        <button class="btn btn-sm btn-light btn-icon text-danger" onclick="eliminarAviso(<?php echo e($a->id); ?>, '<?php echo e($a->titulo); ?>')"><i class="bi bi-trash"></i></button>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\musicarte\resources\views/avisos/index.blade.php ENDPATH**/ ?>