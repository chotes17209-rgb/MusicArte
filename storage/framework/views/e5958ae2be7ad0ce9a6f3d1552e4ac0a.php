<?php $__env->startSection('titulo', 'Planilla Maestros'); ?>

<?php $__env->startSection('contenido'); ?>
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    <div>
        <h5 class="fw-semibold mb-0">Planilla de pago a Maestros</h5>
        <small class="text-muted"><?php echo e(\App\Models\Pago::MESES[$mes]); ?> <?php echo e($anio); ?> — calculada desde la asistencia de los alumnos</small>
    </div>
...
<?php $__currentLoopData = $planillas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="card p-3 mb-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h6 class="fw-semibold mb-0"><i class="bi bi-person-badge me-1"></i> MAESTRO: <?php echo e(strtoupper($grupo['maestro']->nombre ?? 'Sin asignar')); ?></h6>
        <span class="fw-bold" style="color:#3d2c8d">S/ <?php echo e(number_format($grupo['total_monto'], 2)); ?> &middot; <?php echo e($grupo['total_horas']); ?> horas</span>
    </div>
    <div class="table-responsive">
        <table class="table table-sm align-middle mb-0">
            ...
            <tbody>
            <?php $__currentLoopData = $grupo['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="fw-semibold"><?php echo e($p->alumno->nombre ?? '—'); ?></td>
                    <td><?php echo e($p->especialidad->nombre ?? '—'); ?></td>
                    <td><?php echo e($p->horas); ?></td>
                    <td>S/ <?php echo e(number_format($p->monto, 2)); ?></td>
                    <td class="small text-muted"><?php echo e($p->observacion ?? ''); ?></td>
                    <td class="text-end">
                        <?php if(auth()->guard()->check()): ?> <?php if(auth()->user()->esAdmin()): ?>
                        <button class="btn btn-sm btn-light btn-icon" onclick="editarPlanilla(<?php echo e($p->id); ?>)"><i class="bi bi-pencil"></i></button>
                        <button class="btn btn-sm btn-light btn-icon text-danger" onclick="eliminarPlanilla(<?php echo e($p->id); ?>, '<?php echo e($p->alumno->nombre ?? ''); ?>')"><i class="bi bi-trash"></i></button>
                        <?php endif; ?> <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr class="fw-bold"><td colspan="3">TOTAL <?php echo e(strtoupper($grupo['maestro']->nombre ?? '')); ?></td><td>S/ <?php echo e(number_format($grupo['total_monto'], 2)); ?></td><td colspan="2"></td></tr>
            </tbody>
        </table>
    </div>
</div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="generar_anio" value="<?php echo e($anio); ?>">
                    </div>
                </div>
            </div>
        ...
        <form class="modal-content" id="formPlanilla">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3"><label class="form-label small fw-semibold">Ano</label><input type="number" class="form-control" id="planilla_anio" value="<?php echo e($anio); ?>"></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\musicarte\resources\views/planilla/index.blade.php ENDPATH**/ ?>