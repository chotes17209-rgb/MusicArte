        ...
        <table class="table align-middle">
            <thead>
                <tr>
                    ...
                    @auth @if(auth()->user()->esAdmin())<th>Precio mensual</th>@endif @endauth
            ...
            @forelse($especialidades as $e)
                <tr>
                    ...
                    @auth @if(auth()->user()->esAdmin())<td>S/ {{ number_format($e->precio_mensual, 2) }}</td>@endif @endauth
                    <td>{{ $e->alumnos_count }}</td>
